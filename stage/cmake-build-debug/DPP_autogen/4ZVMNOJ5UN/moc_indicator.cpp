...
#include "../../../UI/include/indicator.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSindicatorENDCLASS_t qt_meta_stringdata_CLASSindicatorENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(23, 0),  // ""
        QT_MOC_LITERAL(24, 8),  // "newValue"
        QT_MOC_LITERAL(33, 16),  // "on_build_clicked"
        QT_MOC_LITERAL(50, 19),  // "on_mistakes_clicked"
        QT_MOC_LITERAL(70, 21),  // "on_macAddress_clicked"
        QT_MOC_LITERAL(92, 14)   // "onValueChanged"
    },
    "indicator",
    "valueChanged",
    "",
...
Q_CONSTINIT const QMetaObject indicator::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSindicatorENDCLASS_t,
        ...
        // method 'on_build_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_mistakes_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_macAddress_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
...
void indicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_mistakes_clicked(); break;
        case 3: _t->on_macAddress_clicked(); break;
        ...
        {
            using _t = void (indicator::*)(int );
            if (_t _q_method = &indicator::valueChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void indicator::valueChanged(int _t1)
{
